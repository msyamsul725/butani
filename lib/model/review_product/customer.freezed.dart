...
abstract class $CustomerCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, dynamic photo});
}
...
class _$_Customer implements _Customer {
  _$_Customer({this.id, this.name, this.photo});
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, const DeepCollectionEquality().hash(photo));
...
abstract class _Customer implements Customer {
  factory _Customer({final int? id, final String? name, final dynamic photo}) =
      _$_Customer;
